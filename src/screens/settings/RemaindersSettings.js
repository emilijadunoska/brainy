...
const RemaindersSettings = ({ navigation }) => {
  ...
  const handleConfirm = (date) => {
    ...
    Toast.show({
      ...
      text2: "Your Brainy remainders have been saved.", // Subtext of the toast message
    });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.text}>
        Stay informed and connected with Brainy's daily notifications. By
        checking in with Brainy every day, you'll receive valuable insights,
